                ...
                <form id="formPinjam">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="kelas" class="form-control" required> <!-- Nama input tetap 'kelas' untuk kompatibilitas -->
                            <option value="">-- Pilih Program --</option>
                            <option value="X Kesehatan" selected>X Kesehatan</option> <!-- Default untuk kelas10.php -->
                            <!-- Tambahkan opsi lain jika perlu, atau buat dinamis -->
                            </select>
                    </div>
