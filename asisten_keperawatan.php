...
// Tentukan kategori
$kategori = "asisten_keperawatan";
$judul_halaman = "Buku Program Keahlian Asisten Keperawatan";
$deskripsi_halaman = "Koleksi buku spesifik untuk program studi Asisten Keperawatan";
$ikon = "fas fa-user-nurse";
$warna_utama = "#6a11cb"; // Ungu
$warna_latar = "#e8f5e9"; // Latar belakang hijau muda
...
<head>
    ...
    <style>
        ...
        .btn-pinjam:hover {
            background-color: #580da8; /* Warna sedikit lebih gelap saat hover */
            color: white;
        }
        .modal-body label {
            font-weight: 500;
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="kelas" class="form-control" required>
                                ...
                                <option value="XI Asisten Keperawatan" selected>XI Asisten Keperawatan</option>
