...
// Tentukan kategori
$kategori = "novel";
$judul_halaman = "Koleksi Buku Novel";
$deskripsi_halaman = "Nikmati dunia imajinasi melalui koleksi novel kami";
$ikon = "fas fa-book-reader";
$warna_utama = "#ff758c"; // Merah Muda
$warna_latar = "#fce4ec"; // Latar belakang merah muda
...
<head>
    ...
    <style>
        ...
        .btn-pinjam:hover {
            background-color: #ff5c77; /* Warna sedikit lebih gelap saat hover */
            color: white;
        }
        .modal-body label {
            font-weight: 500;
...
<body>
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <?php else: ?>
                <div class="col-12">
                    <div class="alert alert-info text-center">Tidak ada novel dalam koleksi ini.</div>
                </div>
            <?php endif; ?>
        </div>
    </div>
